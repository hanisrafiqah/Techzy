                ...
                <div class="d-flex justify-content-end">
                    ...
                    @if (Auth::user()->type == UserType::USER)
                        ...
                        <a class="btn-reverse text-center mb-3" href="{{ url('chatify') }}">Chat with a Counsellor
                            {{--   <a href="/appointment">Book</a> --> http://127.0.0.1:8000/appointment --}}
                            @if ($unreadMsg != 0)
                    ...
                    <div class="card m-2">
                        ...
                        <div class="card-body">
                            <div class="nav flex-column nav-pills mb-3 bg-opacity-50 mx-3 p-3" id="v-pills-tab"
                                ...
                                <button style='margin-top:5px; background-color:#20c997; color:black'
                                    class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-settings" type="button" role="tab"
                                    aria-controls="v-pills-settings" aria-selected="false">Book Appointment</button>
                            </div>
                        </div>
                    </div>
                </div>
